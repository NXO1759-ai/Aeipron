...
//   · SET   → every page requires the access code (middleware.ts redirects
...
// it runs in BOTH the Edge runtime (middleware) and Node (route handler),
// unlike node:crypto which middleware can't import.
// ---------------------------------------------------------------------------
