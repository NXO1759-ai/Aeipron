...
//     · "BODY MEASUREMENTS" heading (house uppercase label style) + the
//       8–12" ease line
//     · the garment grid (S–XXL: body length HPS, chest pit-to-pit, chest
//       full circumference, sleeve length from shoulder)
//     · "All measurements in inches."
//
//   "HOW TO MEASURE" button (house uppercase label style) opens a MODAL with:
...
export function SizeGuide() {
  ...
  return (
    <div>
      ...
      <h3 className={HEADING_CLASSES}>Body Measurements</h3>
